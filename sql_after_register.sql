...
('Buddy','MALE',3,'DOG','IDLE','Beagle','{"Arthritis"}','{"Pollen"}','',11),
('Mittens','FEMALE',2,'CAT','IDLE','Siamese','{"Feline Flu"}','{"Dust"}','',11),
('Charlie','MALE',4,'DOG','IDLE','Labrador','{}','{"Peanuts"}','',11),
('Lola','FEMALE',1,'RABBIT','IDLE','Netherland Dwarf','{"Digestive"}','{}','',11),
('Max','MALE',5,'DOG','IDLE','Golden Retriever','{"Skin Infection"}','{"Wheat"}','',11)