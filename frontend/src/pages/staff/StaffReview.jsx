...
const demoReviews = [
  {
    ...
    rating: 4.5,
    reviewText: 'The service was fantastic! Max looks so clean and happy. The staff was very friendly and professional.',
    staffReply: 'Thank you for your kind words, Jane! We were so happy to have Max with us and look forward to seeing you both again soon.',
    image: '', 
  },
  {
    id: 2,
    ...
    rating: 5.0,
    reviewText: 'Quick, easy, and stress-free for Buddy. Exactly what we needed. 10/10 would recommend.',
    staffReply: null,
    image: '',
  },
];
  ...
  return (
    <div style={cardStyle}>
      ...
      <div style={serviceInfoStyle}>
        ...
        <p style={{ margin: 0, color: '#888', fontSize: '0.9rem' }}>{review.reviewDate}</p>
      </div>
      ...
      <div style={reviewContentStyle}>
        ...
        <div style={buttonContainerStyle}>
          <button style={{ ...baseButtonStyle, backgroundColor: '#6F4E37', color: 'white' }}>Delete</button>
    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', margin: '2rem 0', width: '100%', gap: '1rem' }}>
          ...
          <button style={{ padding: '0.75rem 1.5rem', backgroundColor: '#6F4E37', color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer', fontSize: '1.125rem', whiteSpace: 'nowrap', height: '100%' }}>xx/xx/xx</button>
          <button style={{ padding: '0.75rem 1.5rem', backgroundColor: '#6F4E37', color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer', fontSize: '1.125rem', whiteSpace: 'nowrap', height: '100%', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            star <span>▼</span>
          </button>
        </div>
      </div>
